...
urlpatterns = [
    ...
    path('users/profile/picture/', users_api.update_profile_picture, name='profile_picture_upload'),
    path('users/posts/', users_api.get_user_likes_and_posts, name='get_total_posts_and_post_likes'),
