...
urlpatterns = [
    ...
    path('users/profile/picture/', users_api.update_profile_picture,
         name='profile_picture_upload'),
    path('users/posts/', users_api.get_user_likes_and_posts,
    ...
    path('posts/<int:post_id>/likes/',
         posts_api.switch_like, name='switch_post_like'),
